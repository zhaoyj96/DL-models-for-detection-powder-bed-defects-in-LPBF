...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='val', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=180, help='inference size (pixels)')
