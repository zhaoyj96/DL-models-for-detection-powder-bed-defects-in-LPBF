...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('7FFF00', '8b0000', 'FFFF00', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3):
    ...
    if label:
        ...
        cv2.putText(im, label, (c1[0], c1[1] - 2), 0, tl / 6, [255, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
